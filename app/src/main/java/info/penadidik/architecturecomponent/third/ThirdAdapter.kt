...
import info.penadidik.architecturecomponent.third.viewholder.ListFooterViewHolder
import info.penadidik.architecturecomponent.third.viewholder.NewsViewHolder

class ThirdAdapter(private val retry: () -> Unit)
